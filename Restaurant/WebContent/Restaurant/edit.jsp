...
<title>Editare Restaurant</title>
						...
						<div class="col-md-6">
							<div class="box box-primary">
								<div class="box-header with-border">
									<br />
									<h3 class="box-title">Editare Restaurant</h3>
								</div>
								<form:form
									action="${pageContext.request.contextPath}/editare-restaurant-save.htm"
									method="post" modelAttribute="restaurantForm" role="form">
